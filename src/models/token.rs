use crate::graph_schemas::schemas::{Erc721Token, FilterErc721Token, Pagination};
...
impl TokenModel {
    pub async fn get_erc721_tokens(
        ...
        let mut erc721: Vec<Erc721Token> = Vec::new();
    ...
    pub async fn get_token(col: Collection<Erc721Token>, input: FilterErc721Token) -> Result<Erc721Token, Error> {
